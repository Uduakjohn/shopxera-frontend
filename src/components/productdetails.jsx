          ...
          <div className="card p-3 m-auto">
            <div className="card-body">
              ...
              <p className="card-text">
                <span className="text-danger fs-4 me-2">{product.price.toLocaleString()}N</span>
                <strike>{product.price * 2}N</strike>
              </p>
              <p className="card-text">{product.description}</p>
              <p className="card-text mb-3">Lorem ipsum dolor sit amet consectetur adipisicing elit. <br /> Quibusdam tempore unde aperiam, consectetur harum a eum error,
               <br /> libero nemo quisquam ex assumenda corrupti rerum aut quod et sint facere reprehenderit?</p>
